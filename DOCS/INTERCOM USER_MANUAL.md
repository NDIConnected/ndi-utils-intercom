...
1. Download `NDI-Intercom16-Setup-v1.7.6.exe` from the [releases page](https://github.com/NDIConnected/ndi-utils-intercom/releases)
...
1. **Application version**: v1.7.6 (NDI Intercom16)
...
**Manual Version**: 1.7.6  
**Date**: July 2026  
**Application**: NDI Intercom16 & NDI Intercom2 v1.7.6

...
[Messages]
WelcomeLabel2=This will install [name/ver] on your computer.%n%nNDI Intercom16 is a 16-channel NDI intercom with web control, optional ASIO, and NDI Bridge integration.%n%nVersion 1.7.4:%n- Web UI defaults to localhost; optional remote control via tray Web Server Settings%n- Security and publication hardening for public release%n%nSee CHANGELOG.md in the repo or Documentation after install for full release notes.%n%nSelf-contained .NET 8 app — NDI Runtime must be installed separately.
